      ...
      <div class="container-fluid">
            ...
            <div class="card card-info">
              ...
              <form name="form1">
                ...
                <div class="card-footer">
                  <button type="button" class="btn btn-info" id="bt_regist">수정</button>
                  <button type="button" class="btn btn-info" id="bt_regist">삭제</button>
                  <button type="button" class="btn btn-info" id="bt_sub">하위카테고리 등록</button>
		...
		<div class="row" style="display:none" id="subForm">
			<div class="col-12">
	            <div class="card card-info">
	              <div class="card-header">
	                <h3 class="card-title">하위카테고리 등록</h3>
	              </div>
	              <!-- /.card-header -->
	              <!-- form start -->
	              <form name="form2">
